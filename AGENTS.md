...
| S-4 | Kai 傳來一批 PDF 時：①先清點本批共 N 份，回報「收到 N 份，開始處理」；②逐一呼叫 python3 skills/broker-materials/scripts/receive_telegram.py --test-file <路徑> 處理，每份完成後立即回報分類結果；③全批完成後回報「完成：成功 X 份 / 失敗 Y 份」，列出失敗檔名與原因。 |
